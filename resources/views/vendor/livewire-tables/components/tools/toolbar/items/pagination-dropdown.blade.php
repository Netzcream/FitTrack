    ...
    <select wire:model.live="perPage" id="{{ $tableName }}-perPage"
        {{
            ...
            ->class([
                ...
                'p-2.5 block w-full rounded-md shadow-sm transition duration-150 ease-in-out sm:text-sm sm:leading-5 focus:ring focus:ring-opacity-50' => $isTailwind && $this->getPerPageFieldAttributes()['default-styling'],
