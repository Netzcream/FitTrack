 <section class="flex-1 bg-gradient-to-b from-white to-gray-50 dark:from-slate-900 dark:to-slate-950 py-14 sm:py-16 lg:py-20">
        <div class="w-full max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10 lg:gap-12 px-6 sm:px-8">
            <div class="flex-1 flex flex-col items-start justify-center max-w-xl">
                ...
                <p class="text-lg sm:text-xl mb-8 text-slate-700 dark:text-slate-300">
                ...
                <div class="mt-6 flex gap-2 items-center">
                    <img src="https://placehold.co/40x40/4f46e5/fff?text=AP" class="w-10 h-10 rounded-full border-2 border-indigo-100 dark:border-indigo-500/30" alt="Testimonio 1" />
                    <img src="https://placehold.co/40x40/4f46e5/fff?text=SC" class="w-10 h-10 rounded-full border-2 border-indigo-100 dark:border-indigo-500/30" alt="Testimonio 2" />
                    <span class="text-sm ml-2 text-slate-700 dark:text-slate-300">Entrenadores felices y en expansión</span>
                </div>
            </div>
            <div class="flex-1 flex items-center justify-end w-full">
                <div class="relative w-72 sm:w-80 md:w-96 h-[440px] rounded-3xl shadow-xl border-2 border-gray-100 dark:border-slate-800 overflow-hidden">
