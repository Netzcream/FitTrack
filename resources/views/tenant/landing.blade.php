<x-layouts.tenant.guest>
    ...
    <div class="relative h-dvh sm:h-[600px] bg-cover bg-center flex items-center"
        ...
        <div class="relative z-10 w-full max-w-6xl mx-auto px-4  items-center gap-4">
            ...
            <div class="text-white text-center">
                ...
                @if (tenant_config('landing_title') || tenant_config('landing_subtitle'))
                    <div class="mt-8 animate-bounce">
                        <svg class="mx-auto w-6 h-6" fill="none" stroke="white" viewBox="0 0 24 24">
