        ...
        <form wire:submit.prevent="save" class="space-y-6">
            <div>
                <flux:heading size="xl" level="1">
                    {{ $editMode ? __('site.edit_communication_channel') : __('site.new_communication_channel') }}
                </flux:heading>
                <flux:subheading size="lg" class="mb-6">
                    {{ __('site.communication_channel_subheading') }}
                </flux:subheading>
            ...
            <div class="max-w-5xl space-y-6">
                ...
                <div class="flex justify-end gap-4 pt-6 items-center">
                    ...
                    <flux:button as="a" variant="ghost"
                        href="{{ route('tenant.dashboard.communication-channels.index') }}">
                        {{ $editMode ? __('site.back') : __('site.cancel') }}
                    </flux:button>

                    <flux:button type="submit" variant="primary">
                        {{ $editMode ? __('site.update_channel') : __('site.create_channel') }}
                    </flux:button>
                </div>
            </div>
        </form>
