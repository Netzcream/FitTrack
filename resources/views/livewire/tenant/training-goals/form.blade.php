            ...
            <form wire:submit.prevent="save" class="space-y-6">
                <div>
                    <flux:heading size="xl" level="1">
                        {{ $editMode ? __('site.edit_training_goal') : __('site.new_training_goal') }}
                    </flux:heading>
                    <flux:subheading size="lg" class="mb-6">
                        {{ __('site.training_goal_subheading') }}
                    </flux:subheading>
                ...
                <div class="max-w-5xl space-y-6">
                    ...
                    <div class="flex justify-end gap-4 pt-6 items-center">
                        ...
                        <flux:button as="a" variant="ghost"
                            href="{{ route('tenant.dashboard.training-goals.index') }}">
                            {{ $editMode ? __('site.back') : __('site.cancel') }}
                        </flux:button>

                        <flux:button type="submit" variant="primary">
                            {{ $editMode ? __('site.update_goal') : __('site.create_goal') }}
                        </flux:button>
                    </div>
                </div>
            </form>
