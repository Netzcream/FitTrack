<div class="space-y-6 md:space-y-8">
    ...
    <div class="bg-white dark:bg-neutral-900 border border-gray-200 dark:border-neutral-700 rounded-xl overflow-hidden shadow-sm">
        ...
        <div class="h-[500px] overflow-y-auto p-4 space-y-4"
             ...
             x-init="$el.scrollTop = $el.scrollHeight; setInterval(() => scrollIfNeeded(), 3100); window.addEventListener('focus', () => stopTitleNotification()); window.addEventListener('beforeunload', () => stopTitleNotification());"
             @scroll="shouldScroll = Math.abs($el.scrollHeight - $el.scrollTop - $el.clientHeight) < 50"
             @message-sent.window="justSentMessage = true; setTimeout(() => { $el.scrollTop = $el.scrollHeight; stopTitleNotification(); }, 100)">
