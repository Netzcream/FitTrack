<div>
    <div
        ...
        <form wire:submit.prevent="save" wire:key="contact-product-form-{{ $formKey }}" class="space-y-2" autocomplete="off">
            ...
            @error('name')
                <p id="pf-name-error" class="pb-2 text-left text-xs text-red-500">{{ $message }}</p>
            @enderror
            ...
            <input type="email" id="pf-email" name="email" wire:model.defer="email"
                ...
                placeholder="Email *" />
            @error('email')
                <p id="pf-email-error" class="pb-2 text-left text-xs text-red-500">{{ $message }}</p>
            @enderror
            ...
            @error('phone')
                <p id="pf-phone-error" class="pb-2 text-left text-xs text-red-500">{{ $message }}</p>
            @enderror
            ...
            @error('body')
                <p id="pf-body-error" class="pb-2 text-left text-xs text-red-500">{{ $message }}</p>
            @enderror
