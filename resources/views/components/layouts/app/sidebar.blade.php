...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <a href="{{ route('dashboard') }}" class="me-5 flex items-center space-x-2 rtl:space-x-reverse text-indigo-700 dark:text-indigo-300" wire:navigate>
                <x-app-logo-sidebar />
            </a>
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('site.platform')" class="grid">
                    ...
                    @livewire(\App\Livewire\Central\ContactBadgeNavItem::class)
            ...
            <flux:dropdown position="bottom" align="start">
                ...
                <flux:menu class="w-[220px]">
                    ...
                    <flux:menu.radio.group>
                        <flux:menu.item :href="route('central.dashboard.settings.profile')" icon="cog" wire:navigate>{{ __('Settings') }}</flux:menu.item>
                    </flux:menu.radio.group>
