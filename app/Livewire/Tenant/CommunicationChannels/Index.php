...
class Index extends Component
{
    ...
    public ?int $channelToDelete = null;
    ...
    public function delete(): void
    {
        ...
        if ($channel = CommunicationChannel::find($this->channelToDelete)) {
            $channel->delete(); // soft delete
        }

        $this->dispatch('channel-deleted');
        $this->reset('channelToDelete');
    }
    ...
    public function render()
    {
        ...
        return view('livewire.tenant.communication-channels.index', compact('channels'));
    }
}
