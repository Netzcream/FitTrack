        ...
        return [
            ...
            Events\TenancyBootstrapped::class => [
                function (Events\TenancyBootstrapped $event) {
                    ...
                    // Configura el cache key para Spatie Permission
                    $permissionRegistrar = app(\Spatie\Permission\PermissionRegistrar::class);
                    $permissionRegistrar->cacheKey = 'spatie.permission.cache.tenant.' . $tenant->getTenantKey();

                    // Asegura estructura de carpetas en storage/{tenant_id}
                    $storagePath = storage_path(); // ya viene con el sufijo
                    $requiredDirs = [
                        '',
                        'app',
                        'app/livewire-tmp',
                    ...
                    foreach ($requiredDirs as $dir) {
                        $fullPath = $storagePath . DIRECTORY_SEPARATOR . $dir;
                        if (!is_dir($fullPath)) {
